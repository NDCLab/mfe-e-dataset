...
main_df <-  read.csv(file = paste(processed_file_input, "processed_data_mfe_e_Proj_v3.csv", sep ="/", collapse = NULL), stringsAsFactors = FALSE, na.strings=c("", "NA"))
...
mean(main_df$mid_error_hitRate, na.rm = TRUE)
sd(main_df$mid_error_hitRate, na.rm = TRUE)
...
mean(main_df$mid_correct_hitRate, na.rm = TRUE) #
sd(main_df$mid_correct_hitRate, na.rm = TRUE) #
...
t.test(main_df$mid_correct_hitRate, main_df$mid_error_hitRate, paired = TRUE, na.action = na.omit) #
...
lm_for_cor_fit_line <- lm(mid_hitRate_error_minus_correct ~ scaared_b_scrdSoc_s1_r1_e1, main_df)
summary(lm_for_cor_fit_line)

ggplot(main_df, aes(x=scaared_b_scrdSoc_s1_r1_e1, y=mid_hitRate_error_minus_correct)) + geom_point(size = 4) + geom_smooth(method="lm") +
  labs(x = "SCAARED social anxiety score", y = "Middle Error vs. Correct Hit rate") +
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.text = element_text(size = 15)) + theme(text = element_text(size = 18))

ggplot(main_df, aes(x=scaared_b_scrdSoc_s1_r1_e1, y=mid_error_hitRate)) + geom_point(size = 4) + geom_smooth(method="lm") +
  labs(x = "SCAARED social anxiety score", y = "Middle Error Hit rate") +
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.text = element_text(size = 15)) + theme(text = element_text(size = 18))

ggplot(main_df, aes(x=scaared_b_scrdSoc_s1_r1_e1, y=mid_correct_hitRate)) + geom_point(size = 4) + geom_smooth(method="lm") +
  labs(x = "SCAARED social anxiety score", y = "Middle Correct Hit rate") +
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.text = element_text(size = 15)) + theme(text = element_text(size = 18))
...
cor.test(main_df$scaared_b_scrdSoc_s1_r1_e1, main_df$late_correct_hitRate, method = 'pearson', na.action = na.omit)
...
lm_for_cor_fit_line <- lm(mid_hitRate_error_minus_correct ~ scaared_b_scrdTotal_s1_r1_e1, main_df)
summary(lm_for_cor_fit_line)
cor.test(main_df$scaared_b_scrdTotal_s1_r1_e1, main_df$mid_hitRate_error_minus_correct, method = 'pearson', na.action = na.omit)
ggplot(main_df, aes(x=scaared_b_scrdTotal_s1_r1_e1, y=mid_hitRate_error_minus_correct)) + geom_point(size = 4) + geom_smooth(method="lm") +
  labs(x = "SCAARED total anxiety score", y = "middle Error vs. Correct Hit rate") +
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.text = element_text(size = 15)) + theme(text = element_text(size = 18))

cor.test(main_df$scaared_b_scrdTotal_s1_r1_e1, main_df$mid_error_hitRate, method = 'pearson', na.action = na.omit)
ggplot(main_df, aes(x=scaared_b_scrdTotal_s1_r1_e1, y=mid_error_hitRate)) + geom_point(size = 4) + geom_smooth(method="lm") +
  labs(x = "SCAARED total anxiety score", y = "middle Error Hit rate") +
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.text = element_text(size = 15)) + theme(text = element_text(size = 18))

cor.test(main_df$scaared_b_scrdTotal_s1_r1_e1, main_df$mid_correct_hitRate, method = 'pearson', na.action = na.omit)
ggplot(main_df, aes(x=scaared_b_scrdTotal_s1_r1_e1, y=mid_correct_hitRate)) + geom_point(size = 4) + geom_smooth(method="lm") +
  labs(x = "SCAARED total anxiety score", y = "middle Correct Hit rate") +
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), axis.line = element_line(colour = "black")) + theme(axis.text = element_text(size = 15)) + theme(text = element_text(size = 18))
...
current_pep_HR_reg <- lm(early_hitRate_error_minus_correct ~ epepq15_scrdTotal_s1_r1_e1*scaared_b_scrdSoc_s1_r1_e1 , data = main_df)
summary(current_pep_HR_reg)

current_pep_HR_reg <- lm(mid_hitRate_error_minus_correct ~ epepq15_scrdTotal_s1_r1_e1*scaared_b_scrdSoc_s1_r1_e1 , data = main_df)
summary(current_pep_HR_reg)

current_pep_HR_reg <- lm(late_hitRate_error_minus_correct ~ epepq15_scrdTotal_s1_r1_e1*scaared_b_scrdSoc_s1_r1_e1 , data = main_df)
summary(current_pep_HR_reg)
