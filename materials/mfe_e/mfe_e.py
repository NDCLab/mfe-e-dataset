...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/kihossei/Documents/GitHub/mfe_d/materials/PsychopyTask/mfe_d/mfe_d.py',
...
for thisPrac_block_loop in prac_block_loop:
    ...
    for thisPrac_trial_loop in prac_trial_loop:
        ...
        while continueRoutine:
            ...
            # *bigFace* updates
            if bigFace.status == NOT_STARTED and 0.0:
                # keep track of start time/frame for later
